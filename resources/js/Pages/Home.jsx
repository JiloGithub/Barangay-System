    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-neutral-50 text-black antialiased">
                ...
                {/* Sidebar */}
                <aside
                    className={`fixed inset-y-0 left-0 z-50 w-64 transform border-r border-black/10 bg-white shadow-xl transition-transform duration-300 ease-in-out lg:translate-x-0 ${
                    ...
                    <header className="sticky top-0 z-30 border-b border-black/10 bg-white/90 shadow-sm backdrop-blur">
                        <div className="flex items-center justify-between px-6 py-4">
                            ...
                            <div className="flex items-center gap-4">
                                <Link
                                    href="/"
                                    className="hidden items-center gap-2 rounded-lg border border-black/10 bg-white px-3 py-2 text-sm font-medium text-black/70 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-black hover:text-black hover:shadow-md sm:inline-flex"
                                >
